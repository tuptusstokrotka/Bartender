...
MyLeds::MyLeds(uint8_t pixels) : Adafruit_NeoPixel(pixels, LEDS_PIN, LEDS_TYPE) {
...
void MyLeds::ResetGlass(uint8_t num){
    SetGlass(num, _black);
    show();
}
...
void MyLeds::SetGlassPercent(uint8_t num, int percent){
